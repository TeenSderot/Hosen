...
export default function HandIllustration() {
  ...
  return (
    <View style={styles.container}>
      {/* שכבת כף היד - לא לחיצה */}
      <View style={StyleSheet.absoluteFill} pointerEvents="none">
        <Svg viewBox="0 30 272 340" width="100%" height="100%">
          <Path
      ...
      {/* שכבות האצבעות - כל אחת ב-TouchableOpacity משלה */}
      {fingersData.map((finger) => (
  <TouchableOpacity
    key={finger.name}
    onPress={() => handlePress(finger.name)}
    style={{
      position: 'absolute',
      width: finger.width,
      ...
      top: finger.top,
      left: finger.left,
      // כדאי להוסיף צבע רקע זמני כדי לראות את הריבועים בזמן הפיתוח:
      // backgroundColor: 'rgba(255,0,0,0.2)' 
    }}
  >
    <Svg 
      viewBox={`${finger.left} ${finger.top} ${finger.width} ${finger.height}`} 
      width="100%" 
      height="100%"
      pointerEvents="none"
    >
