...
const styles = StyleSheet.create({
  ...
  tagButton: {
    ...
    borderWidth: 2,
    marginBottom: 8,
    // Use logical margin so chip spacing is correct in RTL/LTR
    marginStart: 8,
  },
  tagButtonDefault: {
    backgroundColor: 'white',
  ...
  introCard: {
    ...
    padding: 32,
    alignItems: 'center',
    // Use logical border side so it flips correctly in RTL/LTR
    borderStartWidth: 4,
  ...
  symptomHeaderContent: {
    // Logical row direction so content order respects RTL
    flexDirection: 'row',
    alignItems: 'center',
    flex: 1,
  },
  symptomIconContainer: {
    padding: 12,
    borderRadius: 12,
    // Use marginStart so icon appears on the logical "start" side
    marginStart: 12,
  },
  symptomTitle: {
    fontSize: 18,
  ...
  tagsContainer: {
    // Use row-reverse so tags start from the right edge in RTL
  ...
  summaryItemPhysical: {
    padding: 8,
    backgroundColor: '#71A67419',
    borderRadius: 8,
  },
  summaryItemEmotional: {
    padding: 8,
    backgroundColor: '#FD954E19',
    borderRadius: 8,
  },
  summaryItemCognitive: {
    padding: 8,
    backgroundColor: '#84C7DA19',
    borderRadius: 8,
  },
  summaryItemBehavioral: {
    padding: 8,
    backgroundColor: '#F9F08133',
    borderRadius: 8,
  },
  ...
  summaryItemLabelPhysical: {
    fontWeight: 'bold',
    color: '#71A674',
  },
  summaryItemLabelEmotional: {
    fontWeight: 'bold',
    color: '#FD954E',
  },
  summaryItemLabelCognitive: {
    fontWeight: 'bold',
    color: '#84C7DA',
  },
  summaryItemLabelBehavioral: {
    fontWeight: 'bold',
    color: '#374151',
  },
  noSymptoms: {
